...
IF EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'DatahubPMR.GET_ASSET_RAW_DETAILS') AND TYPE IN (N'P', N'PC'))
BEGIN
...
GO
GRANT EXECUTE ON DatahubPMR.GET_ASSET_RAW_DETAILS TO DMUsr01;
GO
